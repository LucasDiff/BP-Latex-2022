...
\title{Prediction of the winning team in profesional esport matches \br }{Predikcia víťazného tímu v profesionálnych esport zápasoch \br}

%\author{Janko Hraško}
\author{Lukáš}{Németh}
\supervisor{Róbert Rauch} %veduci prace
\consultant{None} %konzultant
